...
const ServiceDetail = () => {
  ...
  const servicesData = {
    ...
    'activaciones-btl': {
      ...
      gradient: 'from-[#B3262E] to-[#B3262E]',
      description: 'Diseñamos e implementamos experiencias presenciales y directas con el publico para generar impacto y conversiones reales.',
      includes: [
        'Concepto creativo y narrativa de activacion',
        'Planificacion y logistica integral',
        'Personal capacitado y coordinacion en sitio',
        'Produccion de materiales y montaje',
        'Permisos y gestion de proveedores',
        'Medicion de resultados y reportes',
      ],
      benefits: [
        'Contacto directo con tu publico objetivo',
        'Mayor recordacion y reconocimiento de marca',
        'Experiencias memorables que impulsan conversion',
        'Datos reales para optimizar futuras acciones',
        'Posicionamiento diferencial en puntos clave',
      ],
      process: [
        { step: 1, title: 'Briefing', description: 'Definimos objetivos, publico y contexto' },
        { step: 2, title: 'Concepto', description: 'Desarrollamos la experiencia y el mensaje' },
        { step: 3, title: 'Planificacion', description: 'Logistica, recursos y cronograma' },
        { step: 4, title: 'Ejecucion', description: 'Implementacion y supervision en sitio' },
