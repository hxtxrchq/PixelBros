...
const SERVICES = [
  {
    ...
    tag: 'Branding',
    gradient: 'linear-gradient(135deg,#7c3aed 0%,#a855f7 50%,#db2777 100%)',
  ...
  },
  {
    ...
    tag: 'Video',
    gradient: 'linear-gradient(135deg,#6d28d9 0%,#e73c50 100%)',
  ...
  },
  {
    ...
    tag: 'BTL',
    gradient: 'linear-gradient(135deg,#d97706 0%,#f59e0b 60%,#ef4444 100%)',
...
const ServiceBentoCard = ({ service }) => (
  <motion.div variants={cardVariants} className={`${service.span} h-full`}>
    <Link to={`/services/${service.slug}`} className="block h-full">
      <motion.div
        className={`group relative h-full overflow-hidden rounded-2xl border border-white/10 hover:border-white/30 transition-colors duration-300 ${
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        {[
          ...
          <div key={s.label} className="bg-white/5 border border-white/8 rounded-2xl px-5 py-4">
      ...
      <motion.div
        ...
        style={{ background: 'linear-gradient(135deg,#474192 0%,#7b3680 50%,#e73c50 100%)' }}
      >
        ...
        <div className="relative z-10">
          ...
          <Link to="/contact">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="px-10 py-4 bg-white text-[#474192] font-black rounded-full text-base shadow-lg transition-all"
            >
